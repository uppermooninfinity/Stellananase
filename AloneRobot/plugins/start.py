...
from AloneRobot.misc import _boot_
from AloneRobot.plugins.sudo.sudoers import sudoers_list
...
from AloneRobot.utils.decorators.language import LanguageStart
from AloneRobot.utils.formatters import get_readable_time
from AloneRobot.utils.inline import first_page, private_panel, start_panel
    ...
    if len(message.text.split()) > 1:
        ...
        if name[0:3] == "inf":
            ...
            key = InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(text=_["S_B_8"], url="https://t.me/dark_musictm"),
