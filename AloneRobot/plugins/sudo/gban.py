...
from AloneRobot.misc import SUDOERS
from AloneRobot.utils import get_readable_time
...
from AloneRobot.utils.extraction import extract_user
from config import BANNED_USERS


@app.on_message(filters.command(["infinityban", "rban"]) & SUDOERS)
@language
...
@app.on_message(filters.command(["unrgban"]) & SUDOERS)
@language
...
@app.on_message(filters.command(["rbannedusers", "rbanlist"]) & SUDOERS)
@language
